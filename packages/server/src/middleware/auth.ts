...
const PUBLIC_PATHS = ['/api/auth/login', '/api/auth/check', '/api/auth/logout', '/api/health', '/api/web/chat', '/api/web/stop', '/api/web/history', '/api/web/subscribe', '/api/web/file', '/api/show/state', '/api/show/session', '/api/metrics']
