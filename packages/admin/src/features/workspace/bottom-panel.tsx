  ...
  return (
    <div className="flex h-full flex-col bg-[var(--card)]">
      ...
      <div
        ref={dragHandleRef}
        className={cn(
          'flex h-10 shrink-0 items-center gap-0 border-b border-[var(--border)] bg-[var(--card)] px-3',
      ...
      >
        ...
        <button
          ...
          title={bottomMaximized ? t('panel.restore') : t('panel.maximize')}
        ...
        <button
          ...
          title={floating ? t('panel.dock') : t('panel.float')}
          className="rounded-md p-1 text-[var(--muted-foreground)] transition-colors hover:bg-[var(--secondary)] hover:text-[var(--foreground)]"
        >
